    ...
    return (
        <div className="flex flex-col w-full h-full bg-white">
            ...
            <nav className="flex flex-col gap-1 p-4 flex-1 overflow-y-auto">
                ...
                <Link className="px-3 py-2 text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors font-medium text-sm flex items-center gap-3" href="/people">
                    People
                </Link>
